...
import "./V4_Bullet_Pump.css" 
import Borewell_V4_Pump_Bullet from "../../../../../assets/Agriculture/Sub-V4-pump.webp" 
import { Link } from "react-router-dom";

export const V4BulletPump = () => { 
  return (
    <div className='Bullet_V4_Pump_Main_Conatiner'>
        <div className="Bullet_V4_Pump_Banner_container">
            <div className="Bullet_V4_Pump_Banner_image">
                <img src={Borewell_V4_Pump_Bullet} alt="Bullet_V4_Pump Banner" className="Bullet_V4_Pump_images"/>
            </div>
            <div className="Bullet_V4_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V4 Bullet Pump</h2> 
                <p>4" (100MM)</p>
            </div>
        </div>
        <div className="Bullet_V4_Pump_Range_Container_one">
        ...
        <div className="Bullet_V4_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Bullet_V4_Pump_Descriptions">
            <div className="Bullet_V4_Pump_text_conatiner">
                ...
                <div className="Bullet_V4_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Bullet_V4_Pump_Contact_Form'>
                                ...
                                <button className='Bullet_V4_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
