...
import "./Agri_Double_Compressor_Pump.css" 
import Agri_Double_Cylinder_Compressor from "../../../../../../assets/Agriculture/Double-Cylinder-Compressor.webp" 
import { Link } from "react-router-dom";

export const AgriDoubleCylinderCompressorPumps = () => { 
  return (
    <div className='Agri_Double_Compressor_Pump_Main_Conatiner'>
        <div className="Agri_Double_Compressor_Pump_Banner_container">
            <div className="Agri_Double_Compressor_Pump_Banner_image">
                <img src={Agri_Double_Cylinder_Compressor} alt="Agri_Double_Compressor_Pump Banner" className="Agri_Double_Compressor_Pump_images"/>
            </div>
            <div className="Agri_Double_Compressor_Pump_Banner_Content">
                <h3>Compressor Pumps</h3>
                <h2>Double Cylinder Compressor Pump</h2> 
                <p>Belt Compressor Pumps</p>
            </div>
        </div>
        <div className="Agri_Double_Compressor_Pump_Range_Container_one">
        ...
        <div className="Agri_Double_Compressor_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Double_Compressor_Pump_Descriptions">
            <div className="Agri_Double_Compressor_Pump_text_conatiner">
                ...
                <div className="Agri_Double_Compressor_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Double_Compressor_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Double_Compressor_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
