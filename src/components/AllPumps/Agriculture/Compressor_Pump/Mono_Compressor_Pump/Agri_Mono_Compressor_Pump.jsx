...
import "./Agri_Mono_Compressor_Pump.css" 
import Agri_Mono_Compressor from "../../../../../assets/Agriculture/Mono-Compressor.webp" 
import { Link } from "react-router-dom";

export const AgriMonoCompressorPumps = () => { 
  return (
    <div className='Agri_Mono_Compressor_Pump_Main_Conatiner'>
        <div className="Agri_Mono_Compressor_Pump_Banner_container">
            <div className="Agri_Mono_Compressor_Pump_Banner_image">
                <img src={Agri_Mono_Compressor} alt="Agri_Mono_Compressor_Pump Banner" className="Agri_Mono_Compressor_Pump_images"/>
            </div>
            <div className="Agri_Mono_Compressor_Pump_Banner_Content">
                <h3>Compressor Pumps</h3>
                <h2>Mono Compressor</h2> 
                {/* <p>Pressure Pumps</p> */}
            </div>
        </div>
        <div className="Agri_Mono_Compressor_Pump_Range_Container_one">
        ...
        <div className="Agri_Mono_Compressor_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Mono_Compressor_Pump_Descriptions">
            <div className="Agri_Mono_Compressor_Pump_text_conatiner">
                ...
                <div className="Agri_Mono_Compressor_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Mono_Compressor_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Mono_Compressor_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/agriculture-pump/agriculture-single-cylinder-compressor-pump" onClick={() => window.scrollTo(0, 0)}><p>1.Single Cylinder Compressor Pump</p></Link>
                        <Link to="/agriculture-pump/agriculture-double-cylinder-compressor-pump" onClick={() => window.scrollTo(0, 0)}><p>2.Double Cylinder Compressor Pump</p></Link>
                    </div>
                </div>
