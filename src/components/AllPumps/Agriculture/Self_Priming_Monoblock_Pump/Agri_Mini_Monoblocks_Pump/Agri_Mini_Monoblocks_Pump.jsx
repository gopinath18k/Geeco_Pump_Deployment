...
import "./Agri_Mini_Monoblocks_Pump.css" 
import Pump_Image_Need from "../../../../../assets/Agriculture/Pump image Needed.webp" 
import { Link } from "react-router-dom";

export const AgriMiniMonoblockPumps = () => { 
  return (
    <div className='Agri_Mini_MonoBlock_Pump_Main_Conatiner'>
        <div className="Agri_Mini_MonoBlock_Pump_Banner_container">
            <div className="Agri_Mini_MonoBlock_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Agri_Mini_MonoBlock_Pump Banner" className="Agri_Mini_MonoBlock_Pump_images"/>
            </div>
            <div className="Agri_Mini_MonoBlock_Pump_Banner_Content">
                <h3>Self Priming Monoblock Pumps</h3>
                <h2>Mini Monoblocks Pump</h2> 
                <p>Self Priming Pumps</p>
            </div>
        </div>
        <div className="Agri_Mini_MonoBlock_Pump_Range_Container_one">
        ...
        <div className="Agri_Mini_MonoBlock_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Mini_MonoBlock_Pump_Descriptions">
            <div className="Agri_Mini_MonoBlock_Pump_text_conatiner">
                ...
                <div className="Agri_Mini_MonoBlock_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Mini_MonoBlock_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Mini_MonoBlock_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
