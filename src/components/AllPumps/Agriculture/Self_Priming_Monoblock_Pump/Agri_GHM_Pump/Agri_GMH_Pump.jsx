...
import "./Agri_GMH_Pump.css" 
import Agri_GMH_Pump from "../../../../../assets/Agriculture/GHM-Pump.webp" 
import { Link } from "react-router-dom";

export const AgriGMHPumps = () => { 
  return (
    <div className='Agri_GMH_Pump_Main_Conatiner'>
        <div className="Agri_GMH_Pump_Banner_container">
            <div className="Agri_GMH_Pump_Banner_image">
                <img src={Agri_GMH_Pump} alt="Agri_GMH_Pump Banner" className="Agri_GMH_Pump_images"/>
            </div>
            <div className="Agri_GMH_Pump_Banner_Content">
                <h3>Self Priming Monoblock Pumps</h3>
                <h2>GMH Pump</h2> 
                <p>Self Priming Pumps</p>
            </div>
        </div>
        <div className="Agri_GMH_Pump_Range_Container_one">
        ...
        <div className="Agri_GMH_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_GMH_Pump_Descriptions">
            <div className="Agri_GMH_Pump_text_conatiner">
                ...
                <div className="Agri_GMH_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_GMH_Pump_Contact_Form'>
                                ...
                                <button className='Agri_GMH_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/agriculture-pump/Agriculture-Self-Priming-Monoblock-Mini-Monoblocks-Pump" onClick={() => window.scrollTo(0, 0)}><p>1.Mini Monoblocks Pump</p></Link>
                        <Link to="/agriculture-pump/Agriculture-Self-Priming-Monoblock-GMH-Pump" onClick={() => window.scrollTo(0, 0)}><p>2.GMH Pump</p></Link>
                    </div>
                </div>
