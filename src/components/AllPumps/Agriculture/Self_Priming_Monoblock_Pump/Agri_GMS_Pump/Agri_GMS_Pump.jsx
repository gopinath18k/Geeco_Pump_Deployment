...
import "./Agri_GMS_Pump.css" 
import Agri_GMS_Pump from "../../../../../assets/Agriculture/GMS-Pump.webp" 
import { Link } from "react-router-dom";

export const AgriGMSPumps = () => { 
  return (
    <div className='Agri_GMS_Pump_Main_Conatiner'>
        <div className="Agri_GMS_Pump_Banner_container">
            <div className="Agri_GMS_Pump_Banner_image">
                <img src={Agri_GMS_Pump} alt="Agri_GMS_Pump Banner" className="Agri_GMS_Pump_images"/>
            </div>
            <div className="Agri_GMS_Pump_Banner_Content">
                <h3>Self Priming Monoblock Pumps</h3>
                <h2>GMS Pump</h2> 
                <p>Self Priming Pumps</p>
            </div>
        </div>
        <div className="Agri_GMS_Pump_Range_Container_one">
        ...
        <div className="Agri_GMS_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_GMS_Pump_Descriptions">
            <div className="Agri_GMS_Pump_text_conatiner">
                ...
                <div className="Agri_GMS_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_GMS_Pump_Contact_Form'>
                                ...
                                <button className='Agri_GMS_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
