...
import "./Agri_Three_Phase_GNC_Panel_Two.css" 
import Agri_Three_Phase_GNC_Two from "../../../../../../assets/Agriculture/Three-Phase-GNC-2.webp" 
import { Link } from "react-router-dom";

export const AgriThreePhaseGNCTwo = () => { 
  return (
    <div className='Agri_Three_Phase_GNC_Two_Main_Conatiner'>
        <div className="Agri_Three_Phase_GNC_Two_Banner_container">
            <div className="Agri_Three_Phase_GNC_Two_Banner_image">
                <img src={Agri_Three_Phase_GNC_Two} alt="Agri_Three_Phase_GNC_Two Banner" className="Agri_Three_Phase_GNC_Two_images"/>
            </div>
            <div className="Agri_Three_Phase_GNC_Two_Banner_Content">
                <h3>Three Phase Panel</h3>
                <h2>GNC Panel 2</h2> 
                <p>Control Panels</p>
            </div>
        </div>
        <div className="Agri_Three_Phase_GNC_Two_Range_Container_one">
        ...
        <div className="Agri_Three_Phase_GNC_Two_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Three_Phase_GNC_Two_Descriptions">
            <div className="Agri_Three_Phase_GNC_Two_text_conatiner">
                ...
                <div className="Agri_Three_Phase_GNC_Two_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Three_Phase_GNC_Two_Contact_Form'>
                                ...
                                <button className='Agri_Three_Phase_GNC_Two_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
