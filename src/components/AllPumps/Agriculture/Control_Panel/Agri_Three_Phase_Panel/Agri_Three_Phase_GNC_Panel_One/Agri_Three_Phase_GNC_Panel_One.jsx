...
import "./Agri_Three_Phase_GNC_Panel_One.css" 
import Agri_Three_Phase_GNC_One from "../../../../../../assets/Agriculture/Three-Phase-GNC-1.webp" 
import { Link } from "react-router-dom";

export const AgriThreePhaseGNCOne = () => { 
  return (
    <div className='Agri_Three_Phase_GNC_One_Main_Conatiner'>
        <div className="Agri_Three_Phase_GNC_One_Banner_container">
            <div className="Agri_Three_Phase_GNC_One_Banner_image">
                <img src={Agri_Three_Phase_GNC_One} alt="Agri_Three_Phase_GNC_One Banner" className="Agri_Three_Phase_GNC_One_images"/>
            </div>
            <div className="Agri_Three_Phase_GNC_One_Banner_Content">
                <h3>Three Phase Panel</h3>
                <h2>GNC Panel 1</h2> 
                <p>Control Panels</p>
            </div>
        </div>
        <div className="Agri_Three_Phase_GNC_One_Range_Container_one">
        ...
        <div className="Agri_Three_Phase_GNC_One_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Three_Phase_GNC_One_Descriptions">
            <div className="Agri_Three_Phase_GNC_One_text_conatiner">
                ...
                <div className="Agri_Three_Phase_GNC_One_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Three_Phase_GNC_One_Contact_Form'>
                                ...
                                <button className='Agri_Three_Phase_GNC_One_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
