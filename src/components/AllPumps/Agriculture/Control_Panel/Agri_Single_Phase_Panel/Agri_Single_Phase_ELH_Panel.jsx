...
import "./Agri_Single_Phase_ELH_Panel.css" 
import Agri_Single_Phase_ELH from "../../../../../assets/Agriculture/Single-Phase-ELH.webp" 
import { Link } from "react-router-dom";

export const AgriSinglePhaseELH = () => { 
  return (
    <div className='Agri_Single_ELH_Panel_Main_Conatiner'>
        <div className="Agri_Single_ELH_Panel_Banner_container">
            <div className="Agri_Single_ELH_Panel_Banner_image">
                <img src={Agri_Single_Phase_ELH} alt="Agri_Single_ELH_Panel Banner" className="Agri_Single_ELH_Panel_images"/>
            </div>
            <div className="Agri_Single_ELH_Panel_Banner_Content">
                <h3>Single Phase Panel</h3>
                <h2>ELH Panel</h2> 
                <p>Control Panels</p>
            </div>
        </div>
        <div className="Agri_Single_ELH_Panel_Range_Container_one">
        ...
        <div className="Agri_Single_ELH_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Single_ELH_Panel_Descriptions">
            <div className="Agri_Single_ELH_Panel_text_conatiner">
                ...
                <div className="Agri_Single_ELH_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Single_ELH_Panel_Contact_Form'>
                                ...
                                <button className='Agri_Single_ELH_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/agriculture-pump/Agriculture-Three-Phase-GNC-Panel-One" onClick={() => window.scrollTo(0, 0)}><p>1.GNC Control Panel 1</p></Link>
                        <Link to="/agriculture-pump/Agriculture-Three-Phase-GNC-Panel-Two" onClick={() => window.scrollTo(0, 0)}><p>2.GNC Control Panel 2</p></Link>
                    </div>
                </div>
