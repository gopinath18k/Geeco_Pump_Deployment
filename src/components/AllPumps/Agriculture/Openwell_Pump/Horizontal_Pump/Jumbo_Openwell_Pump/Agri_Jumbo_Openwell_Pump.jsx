...
import "./Agri_Jumbo_Openwell_Pump.css" 
import Openwell_Jumbo_Pump from "../../../../../../assets/Agriculture/Jumbo_Pump.webp" 
import { Link } from "react-router-dom";

export const AgriJumboOpenwellPumps = () => { 
  return (
    <div className='Agri_Jumbo_Openwell_Pump_Main_Conatiner'>
        <div className="Agri_Jumbo_Openwell_Pump_Banner_container">
            <div className="Agri_Jumbo_Openwell_Pump_Banner_image">
                <img src={Openwell_Jumbo_Pump } alt="Agri_Jumbo_Openwell_Pump Banner" className="Agri_Jumbo_Openwell_Pump_images"/>
            </div>
            <div className="Agri_Jumbo_Openwell_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>Jumbo Horizontal Openwell Pump</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Agri_Jumbo_Openwell_Pump_Range_Container_one">
        ...
        <div className="Agri_Jumbo_Openwell_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Jumbo_Openwell_Pump_Descriptions">
            <div className="Agri_Jumbo_Openwell_Pump_text_conatiner">
                ...
                <div className="Agri_Jumbo_Openwell_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Jumbo_Openwell_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Jumbo_Openwell_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        ...
                        <Link to="/agriculture-pump/Agriculture-SS&MS-Horizontal-Openwell-Pump" onClick={() => window.scrollTo(0, 0)}><p>2.SS & MS Horizontal Openwell Pumps</p></Link>
                                                <Link to="/agriculture-pump/Agriculture-Dolphin&Beluga-Horizontal-Openwell-Pump" onClick={() => window.scrollTo(0, 0)}><p>3.Dolphin & Beluga Horizontal Openwell Pumps</p></Link>
                    </div>
                </div>
