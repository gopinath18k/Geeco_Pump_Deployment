...
import "./ZOW_Pump.css" 
import Borewell_Agri_Zow_Pump from "../../../../../../assets/Agriculture/ZOW-Pumps.webp" 
import { Link } from "react-router-dom";

export const AgricultureZOWOpenwellPump = () => { 
  return (
    <div className='Agri_Zow_Pump_Main_Conatiner'>
        <div className="Agri_Zow_Pump_Banner_container">
            <div className="Agri_Zow_Pump_Banner_image">
                <img src={Borewell_Agri_Zow_Pump} alt="Agri_Zow_Pump Banner" className="Agri_Zow_Pump_images"/>
            </div>
            <div className="Agri_Zow_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>ZOW Openwell Pump</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Agri_Zow_Pump_Range_Container_one">
        ...
        <div className="Agri_Zow_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Zow_Pump_Descriptions">
            <div className="Agri_Zow_Pump_text_conatiner">
                ...
                <div className="Agri_Zow_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Zow_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Zow_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
