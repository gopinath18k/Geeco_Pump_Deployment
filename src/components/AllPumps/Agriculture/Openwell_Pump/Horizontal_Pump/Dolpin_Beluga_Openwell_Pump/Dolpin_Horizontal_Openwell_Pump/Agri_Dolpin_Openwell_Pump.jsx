...
import "./Agri_Dolpin_Openwell_Pump.css" 
import Openwell_Dolphin_Beluga_Pump from "../../../../../../../assets/Agriculture/Dolphin_Beluga_Pump.webp" 
import { Link } from "react-router-dom";

export const AgriDolpinOpenwellPumps = () => { 
  return (
    <div className='Agri_Dolpin_Openwell_Pump_Main_Conatiner'>
        <div className="Agri_Dolpin_Openwell_Pump_Banner_container">
            <div className="Agri_Dolpin_Openwell_Pump_Banner_image">
                <img src={Openwell_Dolphin_Beluga_Pump} alt="Agri_Dolpin_Openwell_Pump Banner" className="Agri_Dolpin_Openwell_Pump_images"/>
            </div>
            <div className="Agri_Dolpin_Openwell_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>Dolphin Openwell Pump</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Agri_Dolpin_Openwell_Pump_Range_Container_one">
        ...
        <div className="Agri_Dolpin_Openwell_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Dolpin_Openwell_Pump_Descriptions">
            <div className="Agri_Dolpin_Openwell_Pump_text_conatiner">
                ...
                <div className="Agri_Dolpin_Openwell_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Dolpin_Openwell_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Dolpin_Openwell_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/agriculture-pump/agriculture-dolphin&beluga-horizontal-openwell-pump/agriculture-beluga-horizontal-openwell-pump" onClick={() => window.scrollTo(0, 0)}><p>1.Beluga Openwell Pump</p></Link>
                    </div>
                </div>
