...
import "./SS_MS_Openwell_Pump.css" 
...
export const AgriSsMsOpenwellPumps = () => {
  return (
    <div className='Agri_Openwell_Horizontal_SsMs_Pump_Main_Conatiner'>
        <div className="Agri_Openwell_Horizontal_SsMs_Pump_Banner_container">
            <div className="Agri_Openwell_Horizontal_SsMs_Pump_Banner_image">
                <img src={Openwell_SS_MS_Pump} alt="Agri_Openwell_Horizontal_SsMs_Pump Banner" className="Agri_Openwell_Horizontal_SsMs_Pump_images"/>
            </div>
            <div className="Agri_Openwell_Horizontal_SsMs_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>SS & MS Openwell Pumps</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Agri_Openwell_Horizontal_SsMs_Pump_Range_Container_one">
        ...
        <div className="Agri_Openwell_Horizontal_SsMs_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Agri_Openwell_Horizontal_SsMs_Pump_Descriptions">
            <div className="Agri_Openwell_Horizontal_SsMs_Pump_text_conatiner">
                ...
                <div className="Agri_Openwell_Horizontal_SsMs_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Agri_Openwell_Horizontal_SsMs_Pump_Contact_Form'>
                                ...
                                <button className='Agri_Openwell_Horizontal_SsMs_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
