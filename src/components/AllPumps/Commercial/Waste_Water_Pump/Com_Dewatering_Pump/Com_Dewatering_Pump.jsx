...
import "./Com_Dewatering_Pump.css"
import commercial_Dewatering_Pump from "../../../../../assets/Domestic/Dewatering-Pump.webp"
import { Link } from "react-router-dom";

export const ComDewateringPump = () => {
  return (
    <div className='Com_Dewatering_Pump_Main_Conatiner'>
        <div className="Com_Dewatering_Pump_Banner_container">
            <div className="Com_Dewatering_Pump_Banner_image">
                <img src={commercial_Dewatering_Pump} alt="Com_Dewatering_Pump Banner" className="Com_Dewatering_Pump_images"/>
            </div>
            <div className="Com_Dewatering_Pump_Banner_Content">
                <h3>Waste water Pumps</h3>
                <h2>Dewatering Pump</h2> 
                {/* <p>Mini Monoblocks</p> */}
            </div>
        </div>
        <div className="Com_Dewatering_Pump_Range_Container_one">
        ...
        <div className="Com_Dewatering_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_Dewatering_Pump_Descriptions">
            <div className="Com_Dewatering_Pump_text_conatiner">
                ...
                <div className="Com_Dewatering_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_Dewatering_Pump_Contact_Form'>
                                ...
                                <button className='Com_Dewatering_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/waste-water-pump/sewage-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Sewage Pump</p></Link>
                        <Link to="/commercial-pump/waste-water-pump/cutter-pump" onClick={() => window.scrollTo(0, 0)}><p>2. Cutter Pump</p></Link>
                    </div>
                </div>
