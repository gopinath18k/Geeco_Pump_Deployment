...
import "./Com_ELH_Auto_Panel.css"
import Com_ELH_Pump from "../../../../../../assets/Agriculture/Single-Phase-ELH.webp"
import { Link } from "react-router-dom";

export const ComELHAutoPanel = () => {
  return (
    <div className='Commercial_ELH_Auto_Panel_Main_Conatiner'>
        <div className="Commercial_ELH_Auto_Panel_Banner_container">
            <div className="Commercial_ELH_Auto_Panel_Banner_image">
                <img src={Com_ELH_Pump} alt="Commercial_ELH_Auto_Panel Banner" className="Commercial_ELH_Auto_Panel_images"/>
            </div>
            <div className="Commercial_ELH_Auto_Panel_Banner_Content">
                <h3>Control Panels</h3>
                <h2>ELH Auto Panel</h2> 
                <p>Single Phase Panel</p>
            </div>
        </div>
        <div className="Commercial_ELH_Auto_Panel_Range_Container_one">
        ...
        <div className="Commercial_ELH_Auto_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Commercial_ELH_Auto_Panel_Descriptions">
            <div className="Commercial_ELH_Auto_Panel_text_conatiner">
                ...
                <div className="Commercial_ELH_Auto_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Commercial_ELH_Auto_Panel_Contact_Form'>
                                ...
                                <button className='Commercial_ELH_Auto_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
