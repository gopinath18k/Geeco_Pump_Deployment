...
import "./Com_Three_GNC2_Panel.css"
import commercial_GNC2_Pump from "../../../../../assets/Agriculture/Three-Phase-GNC-2.webp"
import { Link } from "react-router-dom";

export const ComGNC2Panel = () => {
  return (
    <div className='Commercial_GNC2_Panel_Main_Conatiner'>
        <div className="Commercial_GNC2_Panel_Banner_container">
            <div className="Commercial_GNC2_Panel_Banner_image">
                <img src={commercial_GNC2_Pump} alt="Commercial_GNC2_Panel Banner" className="Commercial_GNC2_Panel_images"/>
            </div>
            <div className="Commercial_GNC2_Panel_Banner_Content">
                <h3>Three Phase Panel</h3>
                <h2>GNC Panel 2</h2> 
                <p>Control Panels</p>
            </div>
        </div>
        <div className="Commercial_GNC2_Panel_Range_Container_one">
        ...
        <div className="Commercial_GNC2_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Commercial_GNC2_Panel_Descriptions">
            <div className="Commercial_GNC2_Panel_text_conatiner">
                ...
                <div className="Commercial_GNC2_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Commercial_GNC2_Panel_Contact_Form'>
                                ...
                                <button className='Commercial_GNC2_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/control-panels/three-phase-panel/gnc-panel-1" onClick={() => window.scrollTo(0, 0)}><p>1. GNC Control Panel 1</p></Link>
                    </div>
                </div>
