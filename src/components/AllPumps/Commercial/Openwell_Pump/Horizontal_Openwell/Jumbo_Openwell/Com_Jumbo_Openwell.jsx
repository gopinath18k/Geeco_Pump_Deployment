...
import "./Com_Jumbo_Openwell.css"
import Commercial_Jumbo_Pump from "../../../../../../assets/Agriculture/Jumbo_Pump.webp"
import { Link } from "react-router-dom";

export const ComJumboPump = () => {
  return (
    <div className='Com_Jumbo_Pump_Main_Conatiner'>
        <div className="Com_Jumbo_Pump_Banner_container">
            <div className="Com_Jumbo_Pump_Banner_image">
                <img src={Commercial_Jumbo_Pump} alt="Com_Jumbo_Pump Banner" className="Com_Jumbo_Pump_images"/>
            </div>
            <div className="Com_Jumbo_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>Jumbo Horizontal Openwell Pump</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Com_Jumbo_Pump_Range_Container_one">
        ...
        <div className="Com_Jumbo_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_Jumbo_Pump_Descriptions">
            <div className="Com_Jumbo_Pump_text_conatiner">
                ...
                <div className="Com_Jumbo_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_Jumbo_Pump_Contact_Form'>
                                ...
                                <button className='Com_Jumbo_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/ss-ms-horizontal-openwell-pumps" onClick={() => window.scrollTo(0, 0)}><p>1. SS & MS Openwell Pumps</p></Link>
                    </div>
                </div>
