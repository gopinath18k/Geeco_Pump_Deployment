...
import "./Com_MS_Amphibian_Pump.css"
import Pump_Image_Need from "../../../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const ComMSAmphibianPump = () => {
  return (
    <div className='Com_MS_Amphibian_Pump_Main_Conatiner'>
        <div className="Com_MS_Amphibian_Pump_Banner_container">
            <div className="Com_MS_Amphibian_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Com_MS_Amphibian_Pump Banner" className="Com_MS_Amphibian_Pump_images"/>
            </div>
            <div className="Com_MS_Amphibian_Pump_Banner_Content">
                <h3>Amphibian Pumps</h3>
                <h2>MS Amphibian Pumps</h2> 
                <p>Horizontal Amphibian</p>
            </div>
        </div>
        <div className="Com_MS_Amphibian_Pump_Range_Container_one">
        ...
        <div className="Com_MS_Amphibian_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_MS_Amphibian_Pump_Descriptions">
            <div className="Com_MS_Amphibian_Pump_text_conatiner">
                ...
                <div className="Com_MS_Amphibian_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_MS_Amphibian_Pump_Contact_Form'>
                                ...
                                <button className='Com_MS_Amphibian_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/ss-ms-amphibian-pumps/ss-amphibian-pump" onClick={() => window.scrollTo(0, 0)}><p>1. SS Amphibian Pump</p></Link>
                    </div>
                </div>
