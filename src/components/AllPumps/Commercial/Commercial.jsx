...
export const Commercial = () => {
  ...
  const pumpData = {
    ...
    "OPENWELL SUBMERSIBLE PUMPS": {
          sizes: {
            "HORIZONTAL OPENWELL": [
              { name: "SS&MS Openwell Pumps", img: Com_SS_MS_OpenWell_Pump, link: "/commercial-pump/ss-ms-horizontal-openwell-pumps" },
              { name: "Jumbo Horizontal Openwell Pumps", img: Com_Jumbo_Pump, link: "/commercial-pump/jumbo-horizontal-openwell-pump" },
            ],
            "HORIZONTAL AMPHIBIEN": [
              { name: "SS&MS Amphibian Pumps", img: Pump_Image_Need, link: "/commercial-pump/ss-ms-amphibian-pumps" },
            ],
          },
    },
    "CENTRIFUGAL MONO BLOCKS": {
          sizes: {
            "MONOBLOCK PUMPS": [
              { name: "SCM Pumps", img: Pump_Image_Need, link: "/commercial-pump/centrifugal-monoblocks-pumps/scm-pump" },
            ],
          },
    },
    "SELF PRIMING MONO BLOCK PUMPS": {
          sizes: {
            "MINI MONOBLOCKS": [
              { name: "Hero Pump", img: commercial_Hero_Pump, link: "/commercial-pump/self-priming-monoblock/hero-pump" },
              { name: "Hero Plus Pump", img:commercial_Hero_Plus_Pump, link: "/commercial-pump/self-priming-monoblock/hero-plus-pump" },
              { name: "Smart Pump", img: commercial_Smart_Pump, link: "/commercial-pump/self-priming-monoblock/smart-pump" },
              { name: "LittleKing Pump", img: commercial_LittleKing_Plus_Pump, link: "/commercial-pump/self-priming-monoblock/littleking-pump" },
              { name: "LittleKing Plus Pump", img: commercial_LittleKing_Plus_Pump, link: "/commercial-pump/self-priming-monoblock/littleking-plus-pump" },
              { name: "Geeco Vale Pump", img: commercial_Geeco_Vale_Pump, link: "/commercial-pump/self-priming-monoblock/geeco-vale-pump" },
            ],
          },
        },
   "WASTE WATER PUMPS": {
        sizes: {
                  "WASTE WATER PUMP": [
                    { name: "Dewatering Pump", img: commercial_Dewatering_Pump, link: "/commercial-pump/waste-water-pump/dewatering-pump" },
                    { name: "Sewage Pump", img: Pump_Image_Need, link: "/commercial-pump/waste-water-pump/sewage-pump" },
                    { name: "Cutter Pump", img: Pump_Image_Need, link: "/commercial-pump/waste-water-pump/cutter-pump" },
                  ],
     ...
     "HIGH PRESSURE PUMP": {
          sizes: {
            "HIGH PRESSURE PUMP": [
              { name: "Horizontal Multistage Pump", img: commercial_Pressure_Booster_Pump, link: "/commercial-pump/high-pressure-pumps/horizontal-multistage-pump" },
              { name: "Vertical Multistage Pump", img: Pump_Image_Need, link: "/commercial-pump/high-pressure-pumps/vertical-multistage-pump" },
              { name: "Vertical Inline Pump", img: Pump_Image_Need, link: "/commercial-pump/high-pressure-pumps/vertical-inline-pump" },
              { name: "High Pressure Car Wash Pump", img: Pump_Image_Need, link: "/commercial-pump/high-pressure-pumps/high-pressure-car-wash-pump" },
            ],
          },
        },
      "TANK COMPRESSOR PUMPS": {
          sizes: {
            "TANK COMPRESSOR PUMP": [
              { name: "GTCS Pump", img: Pump_Image_Need, link: "/commercial-pump/tank-compressor-pumps/gtcs-pump" },
              { name: "GTCD Pump", img: Pump_Image_Need, link: "/commercial-pump/tank-compressor-pumps/gtcd-pump" },
              { name: "GTCDH Pump", img: Pump_Image_Need, link: "/commercial-pump/tank-compressor-pumps/gtcdh-pump" },
        ...
        "CONTROL PANELS": {
              sizes: {
                "SINGLE PHASE PANEL": [
                  { name: "MCB Panel", img: Pump_Image_Need, link: "/commercial-pump/control-panels/single-phase-panels/mcb-panel" },
                  { name: "SWIFT Panel", img: commercial_swift_Pump, link: "/commercial-pump/control-panels/single-phase-panels/swift-panel" },
                  { name: "ELH Panel", img: commercial_ELH_Pump, link: "/commercial-pump/control-panels/single-phase-panels/elh-panel" },
                  { name: "ELH Auto Panel", img: commercial_ELH_Pump, link: "/commercial-pump/control-panels/single-phase-panels/elh-auto-panel" },
                  { name: "ELH Full Auto Panel", img: commercial_ELH_Pump, link: "/commercial-pump/control-panels/single-phase-panels/elh-full-auto-panel" },
                ],
                "THREE PHASE PANEL": [
                  { name: "GNC Panel 1", img: commercial_GNC1_Pump, link: "/commercial-pump/control-panels/three-phase-panel/gnc-panel-1" },
                  { name: "GNC Panel 2", img: commercial_GNC2_Pump, link: "/commercial-pump/control-panels/three-phase-panel/gnc-panel-2" },
                ],
              },
            },
