...
import "./Com_V6_Vinc_Pump.css"
import Com_V6_PVA_Pump from "../../../../../../assets/Agriculture/V6-Premium-Pump.webp"
import { Link } from "react-router-dom";

export const ComV6VincPump = () => {
  return (
    <div className='Com_V6_Vinc_Pump_Main_Conatiner'>
        <div className="Com_V6_Vinc_Pump_Banner_container">
            <div className="Com_V6_Vinc_Pump_Banner_image">
                <img src={Com_V6_PVA_Pump} alt="Com_V6_Vinc_Pump Banner" className="Com_V6_Vinc_Pump_images"/>
            </div>
            <div className="Com_V6_Vinc_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V6 Vinc Pumps</h2> 
                <p>6" (150mm)</p>
            </div>
        </div>
        <div className="Com_V6_Vinc_Pump_Range_Container_one">
        ...
        <div className="Com_V6_Vinc_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_V6_Vinc_Pump_Descriptions">
            <div className="Com_V6_Vinc_Pump_text_conatiner">
                ...
                <div className="Com_V6_Vinc_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_V6_Vinc_Pump_Contact_Form'>
                                ...
                                <button className='Com_V6_Vinc_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
