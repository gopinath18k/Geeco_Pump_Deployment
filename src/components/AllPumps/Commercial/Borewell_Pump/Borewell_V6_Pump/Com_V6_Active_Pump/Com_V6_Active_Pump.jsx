...
import "./Com_V6_Active_Pump.css"
import Com_V6_PVA_Pump from "../../../../../../assets/Agriculture/V6-Premium-Pump.webp"
import { Link } from "react-router-dom";

export const ComV6ActivePump = () => {
  return (
    <div className='Com_V6_Active_Pump_Main_Conatiner'>
        <div className="Com_V6_Active_Pump_Banner_container">
            <div className="Com_V6_Active_Pump_Banner_image">
                <img src={Com_V6_PVA_Pump} alt="Com_V6_Active_Pump Banner" className="Com_V6_Active_Pump_images"/>
            </div>
            <div className="Com_V6_Active_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V6 Active Pumps</h2> 
                <p>6" (150mm)</p>
            </div>
        </div>
        <div className="Com_V6_Active_Pump_Range_Container_one">
        ...
        <div className="Com_V6_Active_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_V6_Active_Pump_Descriptions">
            <div className="Com_V6_Active_Pump_text_conatiner">
                ...
                <div className="Com_V6_Active_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_V6_Active_Pump_Contact_Form'>
                                ...
                                <button className='Com_V6_Active_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/borewell-submersible/v6-premium-pump" onClick={() => window.scrollTo(0, 0)}><p>1. V6 Premium Pump</p></Link>
                        <Link to="/commercial-pump/borewell-submersible/v6-vinc-pump" onClick={() => window.scrollTo(0, 0)}><p>2. V6 Vinc Pumps</p></Link>
                    </div>
                </div>
