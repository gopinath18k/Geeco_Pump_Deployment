...
import "./Com_V4_Sakthi_Pump.css"
import Com_V4_Sakthi_Pump from "../../../../../../assets/Agriculture/Sub-V4-Pump-Bullet.webp"
import { Link } from "react-router-dom";

export const ComV4SakthiPump = () => {
  return (
    <div className='Com_V4_Sakthi_Pump_Main_Conatiner'>
        <div className="Com_V4_Sakthi_Pump_Banner_container">
            <div className="Com_V4_Sakthi_Pump_Banner_image">
                <img src={Com_V4_Sakthi_Pump} alt="Com_V4_Sakthi_Pump Banner" className="Com_V4_Sakthi_Pump_images"/>
            </div>
            <div className="Com_V4_Sakthi_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V4 Sakthi Pumps</h2> 
                <p>4" (100mm)</p>
            </div>
        </div>
        <div className="Com_V4_Sakthi_Pump_Range_Container_one">
        ...
        <div className="Com_V4_Sakthi_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_V4_Sakthi_Pump_Descriptions">
            <div className="Com_V4_Sakthi_Pump_text_conatiner">
                ...
                <div className="Com_V4_Sakthi_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_V4_Sakthi_Pump_Contact_Form'>
                                ...
                                <button className='Com_V4_Sakthi_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/borewell-submersible/v4-tuff-bullet-pumps" onClick={() => window.scrollTo(0, 0)}><p>1. V4 Tuff&Bullet Pump</p></Link>
                    </div>
                </div>
