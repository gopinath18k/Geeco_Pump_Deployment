...
import "./Com_V4_Tuff_Pump.css"
import Commercial_V4_TB_Pump from "../../../../../../../assets//Agriculture/Sub-V4-pump.webp"
import { Link } from "react-router-dom";

export const ComV4TuffPump = () => {
  return (
    <div className='Com_V4_Tuff_Pump_Main_Conatiner'>
        <div className="Com_V4_Tuff_Pump_Banner_container">
            <div className="Com_V4_Tuff_Pump_Banner_image">
                <img src={Commercial_V4_TB_Pump} alt="Com_V4_Tuff_Pump Banner" className="Com_V4_Tuff_Pump_images"/>
            </div>
            <div className="Com_V4_Tuff_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V4 Tuff Pumps</h2> 
                <p>4" (100mm)</p>
            </div>
        </div>
        <div className="Com_V4_Tuff_Pump_Range_Container_one">
        ...
        <div className="Com_V4_Tuff_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_V4_Tuff_Pump_Descriptions">
            <div className="Com_V4_Tuff_Pump_text_conatiner">
                ...
                <div className="Com_V4_Tuff_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_V4_Tuff_Pump_Contact_Form'>
                                ...
                                <button className='Com_V4_Tuff_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/commercial-pump/borewell-submersible/v4-tuff-bullet-pumps/v4-bullet-pump" onClick={() => window.scrollTo(0, 0)}><p>1. V4 Bullet Pump</p></Link>
                    </div>
                </div>
