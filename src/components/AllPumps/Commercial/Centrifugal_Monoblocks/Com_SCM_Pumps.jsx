...
import "./Com_SCM_Pumps.css"
import Pump_Image_Need from "../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const ComSCMPump = () => {
  return (
    <div className='Com_SCM_Pump_Main_Conatiner'>
        <div className="Com_SCM_Pump_Banner_container">
            <div className="Com_SCM_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Com_SCM_Pump Banner" className="Com_SCM_Pump_images"/>
            </div>
            <div className="Com_SCM_Pump_Banner_Content">
                <h3>Centrifugal Monoblocks Pumps</h3>
                <h2>SCM Pumps</h2> 
                <p>Monoblock Pumps</p>
            </div>
        </div>
        <div className="Com_SCM_Pump_Range_Container_one">
        ...
        <div className="Com_SCM_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Com_SCM_Pump_Descriptions">
            <div className="Com_SCM_Pump_text_conatiner">
                ...
                <div className="Com_SCM_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Com_SCM_Pump_Contact_Form'>
                                ...
                                <button className='Com_SCM_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
