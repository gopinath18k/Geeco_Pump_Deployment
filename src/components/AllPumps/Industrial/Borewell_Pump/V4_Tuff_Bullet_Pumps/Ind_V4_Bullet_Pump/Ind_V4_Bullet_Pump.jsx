...
import "./Ind_V4_Bullet_Pump.css"
import Ind_V4_TB_Pump from "../../../../../../assets/Agriculture/Sub-V4-pump.webp"
import { Link } from "react-router-dom";

export const IndV4BulletPump = () => {
  return (
    <div className='Ind_V4_Bullet_Pump_Main_Conatiner'>
        <div className="Ind_V4_Bullet_Pump_Banner_container">
            <div className="Ind_V4_Bullet_Pump_Banner_image">
                <img src={Ind_V4_TB_Pump} alt="Ind_V4_Bullet_Pump Banner" className="Ind_V4_Bullet_Pump_images"/>
            </div>
            <div className="Ind_V4_Bullet_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V4 Bullet Pumps</h2> 
                <p>4" (100mm)</p>
            </div>
        </div>
        <div className="Ind_V4_Bullet_Pump_Range_Container_one">
        ...
        <div className="Ind_V4_Bullet_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_V4_Bullet_Pump_Descriptions">
            <div className="Ind_V4_Bullet_Pump_text_conatiner">
                ...
                <div className="Ind_V4_Bullet_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_V4_Bullet_Pump_Contact_Form'>
                                ...
                                <button className='Ind_V4_Bullet_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
