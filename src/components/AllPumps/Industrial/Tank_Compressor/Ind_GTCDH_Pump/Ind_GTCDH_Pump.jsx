...
import "./Ind_GTCDH_Pump.css"
import Pump_Image_Need from "../../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const IndGTCDHPump = () => {
  return (
    <div className='Ind_GTCDH_Pump_Main_Conatiner'>
        <div className="Ind_GTCDH_Pump_Banner_container">
            <div className="Ind_GTCDH_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Ind_GTCDH_Pump Banner" className="Ind_GTCDH_Pump_images"/>
            </div>
            <div className="Ind_GTCDH_Pump_Banner_Content">
                <h3>Tank Compressor Pump</h3>
                <h2>GTCDH Pump</h2> 
                {/* <p>Mini Monoblocks</p> */}
            </div>
        </div>
        <div className="Ind_GTCDH_Pump_Range_Container_one">
        ...
        <div className="Ind_GTCDH_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_GTCDH_Pump_Descriptions">
            <div className="Ind_GTCDH_Pump_text_conatiner">
                ...
                <div className="Ind_GTCDH_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_GTCDH_Pump_Contact_Form'>
                                ...
                                <button className='Ind_GTCDH_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/industrial-pump/tank-compressor-pumps/gtcs-pump" onClick={() => window.scrollTo(0, 0)}><p>1. GTCS Pump</p></Link>
                        <Link to="/industrial-pump/tank-compressor-pumps/gtcd-pump" onClick={() => window.scrollTo(0, 0)}><p>2. GTCD Pump</p></Link>
                    </div>
                </div>
