...
import "./Ind_Jumbo_Vertical_Openwell_Pump.css" 
import Openwell_Jumbo_Pump from "../../../../../../assets/Agriculture/Jumbo-Vertical-Pump.webp" 
import { Link } from "react-router-dom";

export const IndJumboVerticalOpenwellPumps = () => { 
  return (
    <div className='Ind_Jumbo_Openwell_Pump_Main_Conatiner'>
        <div className="Ind_Jumbo_Openwell_Pump_Banner_container">
            <div className="Ind_Jumbo_Openwell_Pump_Banner_image">
                <img src={Openwell_Jumbo_Pump } alt="Ind_Jumbo_Openwell_Pump Banner" className="Ind_Jumbo_Openwell_Pump_images"/>
            </div>
            <div className="Ind_Jumbo_Openwell_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>Jumbo Vertical Openwell Pump</h2> 
                <p>Vertical Openwell</p>
            </div>
        </div>
        <div className="Ind_Jumbo_Openwell_Pump_Range_Container_one">
        ...
        <div className="Ind_Jumbo_Openwell_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_Jumbo_Openwell_Pump_Descriptions">
            <div className="Ind_Jumbo_Openwell_Pump_text_conatiner">
                ...
                <div className="Ind_Jumbo_Openwell_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_Jumbo_Openwell_Pump_Contact_Form'>
                                ...
                                <button className='Ind_Jumbo_Openwell_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/industrial-pump/ss-ms-vertical-openwell-pump" onClick={() => window.scrollTo(0, 0)}><p>1. SS & MS Vertical Openwell Pumps</p></Link>
                    </div>
                </div>
