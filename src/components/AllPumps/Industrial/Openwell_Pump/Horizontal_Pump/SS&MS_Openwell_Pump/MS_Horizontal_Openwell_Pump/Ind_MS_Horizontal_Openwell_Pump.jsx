...
import "./Ind_MS_Horizontal_Openwell_Pump.css" 
import Openwell_SSMS_Pump from "../../../../../../../assets/Agriculture/SS_MS_OpenWell_Pump.webp" 
import { Link } from "react-router-dom";

export const IndMsOpenwellPumps = () => { 
  return (
    <div className='Ind_Openwell_Horizontal_Ms_Pump_Main_Conatiner'>
        <div className="Ind_Openwell_Horizontal_Ms_Pump_Banner_container">
            <div className="Ind_Openwell_Horizontal_Ms_Pump_Banner_image">
                <img src={Openwell_SSMS_Pump} alt="Ind_Openwell_Horizontal_Ms_Pump Banner" className="Ind_Openwell_Horizontal_Ms_Pump_images"/>
            </div>
            <div className="Ind_Openwell_Horizontal_Ms_Pump_Banner_Content">
                <h3>Openwell Submersible Pumps</h3>
                <h2>MS Openwell Pumps</h2> 
                <p>Horizontal Openwell</p>
            </div>
        </div>
        <div className="Ind_Openwell_Horizontal_Ms_Pump_Range_Container_one">
        ...
        <div className="Ind_Openwell_Horizontal_Ms_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_Openwell_Horizontal_Ms_Pump_Descriptions">
            <div className="Ind_Openwell_Horizontal_Ms_Pump_text_conatiner">
                ...
                <div className="Ind_Openwell_Horizontal_Ms_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_Openwell_Horizontal_Ms_Pump_Contact_Form'>
                                ...
                                <button className='Ind_Openwell_Horizontal_Ms_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>  
