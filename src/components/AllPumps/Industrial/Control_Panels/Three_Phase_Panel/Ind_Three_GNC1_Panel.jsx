...
import "./Ind_Three_GNC1_Panel.css"
import commercial_GNC1_Pump from "../../../../../assets/Agriculture/Three-Phase-GNC-1.webp"
import { Link } from "react-router-dom";

export const IndGNC1Panel = () => {
  return (
    <div className='Ind_GNC1_Panel_Main_Conatiner'>
        <div className="Ind_GNC1_Panel_Banner_container">
            <div className="Ind_GNC1_Panel_Banner_image">
                <img src={commercial_GNC1_Pump} alt="Ind_GNC1_Panel Banner" className="Ind_GNC1_Panel_images"/>
            </div>
            <div className="Ind_GNC1_Panel_Banner_Content">
                <h3>Three Phase Panel</h3>
                <h2>GNC Panel 1</h2> 
                <p>Control Panels</p>
            </div>
        </div>
        <div className="Ind_GNC1_Panel_Range_Container_one">
        ...
        <div className="Ind_GNC1_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_GNC1_Panel_Descriptions">
            <div className="Ind_GNC1_Panel_text_conatiner">
                ...
                <div className="Ind_GNC1_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_GNC1_Panel_Contact_Form'>
                                ...
                                <button className='Ind_GNC1_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/industrial-pump/control-panels/three-phase-panel/gnc-panel-2" onClick={() => window.scrollTo(0, 0)}><p>1. GNC Control Panel 2</p></Link>
                    </div>
                </div>
