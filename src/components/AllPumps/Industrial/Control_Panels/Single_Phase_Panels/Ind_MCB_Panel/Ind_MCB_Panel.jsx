...
import "./Ind_MCB_Panel.css"
import Pump_Image_Need from "../../../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const IndMCBPanel = () => {
  return (
    <div className='Ind_MCB_Panel_Main_Conatiner'>
        <div className="Ind_MCB_Panel_Banner_container">
            <div className="Ind_MCB_Panel_Banner_image">
                <img src={Pump_Image_Need} alt="Ind_MCB_Panel Banner" className="Ind_MCB_Panel_images"/>
            </div>
            <div className="Ind_MCB_Panel_Banner_Content">
                <h3>Control Panels</h3>
                <h2>MCB Panel</h2> 
                <p>Single Phase Panel</p>
            </div>
        </div>
        <div className="Ind_MCB_Panel_Range_Container_one">
        ...
        <div className="Ind_MCB_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_MCB_Panel_Descriptions">
            <div className="Ind_MCB_Panel_text_conatiner">
                ...
                <div className="Ind_MCB_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_MCB_Panel_Contact_Form'>
                                ...
                                <button className='Ind_MCB_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/industrial-pump/control-panels/single-phase-panels/swift-panel" onClick={() => window.scrollTo(0, 0)}><p>1. SWIFT Panel</p></Link>
