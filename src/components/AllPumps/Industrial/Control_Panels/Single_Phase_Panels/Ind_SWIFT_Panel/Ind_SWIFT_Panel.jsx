...
import "./Ind_SWIFT_Panel.css"
import Com_swift_Pump from "../../../../../../assets/Agriculture/Three-Phase-GNC-1.webp"
import { Link } from "react-router-dom";

export const IndSWIFTPanel = () => {
  return (
    <div className='Ind_SWIFT_Panel_Main_Conatiner'>
        <div className="Ind_SWIFT_Panel_Banner_container">
            <div className="Ind_SWIFT_Panel_Banner_image">
                <img src={Com_swift_Pump} alt="Ind_SWIFT_Panel Banner" className="Ind_SWIFT_Panel_images"/>
            </div>
            <div className="Ind_SWIFT_Panel_Banner_Content">
                <h3>Control Panels</h3>
                <h2>SWIFT Panel</h2> 
                <p>Single Phase Panel</p>
            </div>
        </div>
        <div className="Ind_SWIFT_Panel_Range_Container_one">
        ...
        <div className="Ind_SWIFT_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_SWIFT_Panel_Descriptions">
            <div className="Ind_SWIFT_Panel_text_conatiner">
                ...
                <div className="Ind_SWIFT_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_SWIFT_Panel_Contact_Form'>
                                ...
                                <button className='Ind_SWIFT_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        ...
                        <Link to="/industrial-pump/control-panels/single-phase-panels/elh-panel" onClick={() => window.scrollTo(0, 0)}><p>2. ELH Panel</p></Link>
                        <Link to="/industrial-pump/control-panels/single-phase-panels/elh-auto-panel" onClick={() => window.scrollTo(0, 0)}><p>3. ELH Auto Panel</p></Link>
                        <Link to="/industrial-pump/control-panels/single-phase-panels/elh-full-auto-panel" onClick={() => window.scrollTo(0, 0)}><p>4. ELH Full Auto Panel</p></Link>
                    </div>
                </div>
