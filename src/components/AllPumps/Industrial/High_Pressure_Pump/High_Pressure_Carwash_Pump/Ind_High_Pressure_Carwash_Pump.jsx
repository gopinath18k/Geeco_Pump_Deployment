...
import "./Ind_High_Pressure_Carwash_Pump.css"
import Pump_Image_Need from "../../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const IndCarwashPump = () => {
  return (
    <div className='Ind_Carwash_Pump_Main_Conatiner'>
        <div className="Ind_Carwash_Pump_Banner_container">
            <div className="Ind_Carwash_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Ind_Carwash_Pump Banner" className="Ind_Carwash_Pump_images"/>
            </div>
            <div className="Ind_Carwash_Pump_Banner_Content">
                <h3>High Pressure Pumps</h3>
                <h2>High pressure Car wash pump</h2> 
                {/* <p>Mini Monoblocks</p> */}
            </div>
        </div>
        <div className="Ind_Carwash_Pump_Range_Container_one">
        ...
        <div className="Ind_Carwash_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_Carwash_Pump_Descriptions">
            <div className="Ind_Carwash_Pump_text_conatiner">
                ...
                <div className="Ind_Carwash_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_Carwash_Pump_Contact_Form'>
                                ...
                                <button className='Ind_Carwash_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        ...
                        <Link to="/industrial-pump/high-pressure-pumps/vertical-inline-pump" onClick={() => window.scrollTo(0, 0)}><p>3. Vertical Inline Pump</p></Link>
                    </div>
                </div>
