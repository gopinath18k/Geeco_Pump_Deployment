...
import "./Ind_Horizontal_Multistage_Pump.css"
import Ind_Pressure_Booster_Pump from "../../../../../assets/Domestic/Domestic-Pressure-Booster-Pump.webp"
import { Link } from "react-router-dom";

export const IndHorizontalMultistagePump = () => {
  return (
    <div className='Ind_Horizontal_Multistage_Pump_Main_Conatiner'>
        <div className="Ind_Horizontal_Multistage_Pump_Banner_container">
            <div className="Ind_Horizontal_Multistage_Pump_Banner_image">
                <img src={Ind_Pressure_Booster_Pump} alt="Ind_Horizontal_Multistage_Pump Banner" className="Ind_Horizontal_Multistage_Pump_images"/>
            </div>
            <div className="Ind_Horizontal_Multistage_Pump_Banner_Content">
                <h3>High Pressure Pumps</h3>
                <h2>Horizontal Multistage Pump</h2> 
                {/* <p>Mini Monoblocks</p> */}
            </div>
        </div>
        <div className="Ind_Horizontal_Multistage_Pump_Range_Container_one">
        ...
        <div className="Ind_Horizontal_Multistage_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Ind_Horizontal_Multistage_Pump_Descriptions">
            <div className="Ind_Horizontal_Multistage_Pump_text_conatiner">
                ...
                <div className="Ind_Horizontal_Multistage_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Ind_Horizontal_Multistage_Pump_Contact_Form'>
                                ...
                                <button className='Ind_Horizontal_Multistage_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/industrial-pump/high-pressure-pumps/vertical-multistage-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Vertical Multistage Pump</p></Link>
                        <Link to="/industrial-pump/high-pressure-pumps/vertical-inline-pump" onClick={() => window.scrollTo(0, 0)}><p>2. Vertical Inline Pump</p></Link>
