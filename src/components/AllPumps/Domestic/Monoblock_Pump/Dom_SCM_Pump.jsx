...
import "./Dom_SCM_Pump.css"
import Pump_Image_Need from "../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const DomScmPump = () => {
  return (
    <div className='Domestic_Mono_Scm_Pump_Main_Conatiner'>
        <div className="Domestic_Mono_Scm_Pump_Banner_container">
            <div className="Domestic_Mono_Scm_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Domestic_Mono_Scm_Pump Banner" className="Domestic_Mono_Scm_Pump_images"/>
            </div>
            <div className="Domestic_Mono_Scm_Pump_Banner_Content">
                <h3>Centrifugal Monoblocks Pumps</h3>
                <h2>SCM Pumps</h2> 
                <p>Monoblock Pumps</p>
            </div>
        </div>
        <div className="Domestic_Mono_Scm_Pump_Range_Container_one">
        ...
        <div className="Domestic_Mono_Scm_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Mono_Scm_Pump_Descriptions">
            <div className="Domestic_Mono_Scm_Pump_text_conatiner">
                ...
                <div className="Domestic_Mono_Scm_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Mono_Scm_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Mono_Scm_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
