...
import "./Domestic_Smart_Pump.css"
import Domestic_Smart_Pump from "../../../../../../assets/Domestic/Smart-Pump.webp"
import { Link } from "react-router-dom";

export const DomesticSmartPump = () => {
  return (
    <div className='Domestic_Mini_Smart_Pump_Main_Conatiner'>
        <div className="Domestic_Mini_Smart_Pump_Banner_container">
            <div className="Domestic_Mini_Smart_Pump_Banner_image">
                <img src={Domestic_Smart_Pump} alt="Domestic_Mini_Smart_Pump Banner" className="Domestic_Mini_Smart_Pump_images"/>
            </div>
            <div className="Domestic_Mini_Smart_Pump_Banner_Content">
                <h3>Self Priming Monoblock Pumps</h3>
                <h2>Smart Pump</h2> 
                <p>Mini Monoblocks</p>
            </div>
        </div>
        <div className="Domestic_Mini_Smart_Pump_Range_Container_one">
        ...
        <div className="Domestic_Mini_Smart_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Mini_Smart_Pump_Descriptions">
            <div className="Domestic_Mini_Smart_Pump_text_conatiner">
                ...
                <div className="Domestic_Mini_Smart_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Mini_Smart_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Mini_Smart_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
