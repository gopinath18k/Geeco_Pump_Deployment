...
import "./Domestic_Hero_Pump.css"
import Domestic_Hero_Pump from "../../../../../../assets/Domestic/Hero-Pump.webp"
import { Link } from "react-router-dom";

export const DomesticHeroPump = () => {
  return (
    <div className='Domestic_Mini_Hero_Pump_Main_Conatiner'>
        <div className="Domestic_Mini_Hero_Pump_Banner_container">
            <div className="Domestic_Mini_Hero_Pump_Banner_image">
                <img src={Domestic_Hero_Pump} alt="Domestic_Mini_Hero_Pump Banner" className="Domestic_Mini_Hero_Pump_images"/>
            </div>
            <div className="Domestic_Mini_Hero_Pump_Banner_Content">
                <h3>Self Priming Monoblock Pumps</h3>
                <h2>Hero Pump</h2> 
                <p>Mini Monoblocks</p>
            </div>
        </div>
        <div className="Domestic_Mini_Hero_Pump_Range_Container_one">
        ...
        <div className="Domestic_Mini_Hero_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Mini_Hero_Pump_Descriptions">
            <div className="Domestic_Mini_Hero_Pump_text_conatiner">
                ...
                <div className="Domestic_Mini_Hero_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Mini_Hero_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Mini_Hero_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/self-priming-monoblock/hero-plus-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Hero Plus Pump</p></Link>
