...
import "./Domestic_RO_Pump.css"
import Domestic_RO_Pump from "../../../../../assets/Domestic/Domestic-Pressure-Booster-Pump.webp"
import { Link } from "react-router-dom";

export const DomesticROPump = () => {
  return (
    <div className='Domestic_Vertical_RO_Pump_Main_Conatiner'>
        <div className="Domestic_Vertical_RO_Pump_Banner_container">
            <div className="Domestic_Vertical_RO_Pump_Banner_image">
                <img src={Domestic_RO_Pump} alt="Domestic_Vertical_RO_Pump Banner" className="Domestic_Vertical_RO_Pump_images"/>
            </div>
            <div className="Domestic_Vertical_RO_Pump_Banner_Content">
                <h3>High Pressure Pumps</h3>
                <h2>Domestic RO Pump</h2> 
                <p>Vertical Multistage Pumps</p>
            </div>
        </div>
        <div className="Domestic_Vertical_RO_Pump_Range_Container_one">
        ...
        <div className="Domestic_Vertical_RO_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Vertical_RO_Pump_Descriptions">
            <div className="Domestic_Vertical_RO_Pump_text_conatiner">
                ...
                <div className="Domestic_Vertical_RO_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Vertical_RO_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Vertical_RO_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/high-pressure/horizontal-multistage/domestic-pressure-booster-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Horizontal Multistage Pump</p></Link>
                    </div>
                </div>
