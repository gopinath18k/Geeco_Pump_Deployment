...
import "./Domestic_Pressure_Booster-Pump.css"
import Domestic_Pressure_Booster_Pump from "../../../../../assets/Domestic/Domestic-Pressure-Booster-Pump.webp"
import { Link } from "react-router-dom";

export const DomesticPressureBoosterPump = () => {
  return (
    <div className='Domestic_Horizontal_Pressure_Pump_Main_Conatiner'>
        <div className="Domestic_Horizontal_Pressure_Pump_Banner_container">
            <div className="Domestic_Horizontal_Pressure_Pump_Banner_image">
                <img src={Domestic_Pressure_Booster_Pump} alt="Domestic_Horizontal_Pressure_Pump Banner" className="Domestic_Horizontal_Pressure_Pump_images"/>
            </div>
            <div className="Domestic_Horizontal_Pressure_Pump_Banner_Content">
                <h3>High Pressure Pumps</h3>
                <h2>Domestic Pressure Booster pump</h2> 
                <p>Horizontal Multistage Pump</p>
            </div>
        </div>
        <div className="Domestic_Horizontal_Pressure_Pump_Range_Container_one">
        ...
        <div className="Domestic_Horizontal_Pressure_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Horizontal_Pressure_Pump_Descriptions">
            <div className="Domestic_Horizontal_Pressure_Pump_text_conatiner">
                ...
                <div className="Domestic_Horizontal_Pressure_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Horizontal_Pressure_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Horizontal_Pressure_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/high-pressure/vertical-multistage/domestic-ro-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Vertical Multistage Pump</p></Link>
                    </div>
                </div>
