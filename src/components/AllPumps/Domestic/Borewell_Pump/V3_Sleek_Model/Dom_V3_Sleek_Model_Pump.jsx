...
import "./Dom_V3_Sleek_Model_Pump.css"
import Pump_Image_Need from "../../../../../assets/Agriculture/Pump image Needed.webp"
import { Link } from "react-router-dom";

export const DomV3SleekPump = () => {
  return (
    <div className='Dom_V3_Sleek_Pump_Main_Conatiner'>
        <div className="Dom_V3_Sleek_Pump_Banner_container">
            <div className="Dom_V3_Sleek_Pump_Banner_image">
                <img src={Pump_Image_Need} alt="Dom_V3_Sleek_Pump Banner" className="Dom_V3_Sleek_Pump_images"/>
            </div>
            <div className="Dom_V3_Sleek_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V3 Sleek Model</h2> 
                <p>3" (75mm)</p>
            </div>
        </div>
        <div className="Dom_V3_Sleek_Pump_Range_Container_one">
        ...
        <div className="Dom_V3_Sleek_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Dom_V3_Sleek_Pump_Descriptions">
            <div className="Dom_V3_Sleek_Pump_text_conatiner">
                ...
                <div className="Dom_V3_Sleek_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Dom_V3_Sleek_Pump_Contact_Form'>
                                ...
                                <button className='Dom_V3_Sleek_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/V4-LittleSub-Pump" onClick={() => window.scrollTo(0, 0)}><p>1. 4" (100mm) Pumps</p></Link>
                    </div>
                </div>
