...
import "./Dom_V4_Taurus_Pump.css"
import Domestic_V4_FTS_Pump from "../../../../../../../assets/Domestic/V4-Flora-Pump.webp"
import { Link } from "react-router-dom";

export const DomV4TaurusPump = () => {
  return (
    <div className='Dom_V4_Taurus_Pump_Main_Conatiner'>
        <div className="Dom_V4_Taurus_Pump_Banner_container">
            <div className="Dom_V4_Taurus_Pump_Banner_image">
                <img src={Domestic_V4_FTS_Pump} alt="Dom_V4_Taurus_Pump Banner" className="Dom_V4_Taurus_Pump_images"/>
            </div>
            <div className="Dom_V4_Taurus_Pump_Banner_Content">
                <h3>Borewell Submersible Pumps</h3>
                <h2>V4 Taurus Pump</h2> 
                <p>4" (100mm)</p>
            </div>
        </div>
        <div className="Dom_V4_Taurus_Pump_Range_Container_one">
        ...
        <div className="Dom_V4_Taurus_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Dom_V4_Taurus_Pump_Descriptions">
            <div className="Dom_V4_Taurus_Pump_text_conatiner">
                ...
                <div className="Dom_V4_Taurus_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Dom_V4_Taurus_Pump_Contact_Form'>
                                ...
                                <button className='Dom_V4_Taurus_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        ...
                        <Link to="/domestic-pump/borewell-v4-sakthi-pump" onClick={() => window.scrollTo(0, 0)}><p>3. V4 Sakthi Pump</p></Link>
                    </div>
                </div>
