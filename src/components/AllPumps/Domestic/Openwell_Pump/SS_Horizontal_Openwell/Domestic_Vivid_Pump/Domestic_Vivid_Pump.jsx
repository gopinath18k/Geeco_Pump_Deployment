...
import "./Domestic_Vivid_Pump.css"
import Domestic_SS_Vivid_Pump from "../../../../../../assets/Agriculture/SS-Vivid-Pump.webp"
import { Link } from "react-router-dom";

export const DomVividPump = () => {
  return (
    <div className='Domestic_Vivid_Pump_Main_Conatiner'>
        <div className="Domestic_Vivid_Pump_Banner_container">
            <div className="Domestic_Vivid_Pump_Banner_image">
                <img src={Domestic_SS_Vivid_Pump} alt="Domestic_Vivid_Pump Banner" className="Domestic_Vivid_Pump_images"/>
            </div>
            <div className="Domestic_Vivid_Pump_Banner_Content">
                <h3>SS Openwell Submersible Pumps</h3>
                <h2>Vivid Pump</h2> 
                <p>Horizontal Openwell Submersible Pumps</p>
            </div>
        </div>
        <div className="Domestic_Vivid_Pump_Range_Container_one">
        ...
        <div className="Domestic_Vivid_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Vivid_Pump_Descriptions">
            <div className="Domestic_Vivid_Pump_text_conatiner">
                ...
                <div className="Domestic_Vivid_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Vivid_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Vivid_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/ss-horizontal-openwell-pumps/zip-pump" onClick={() => window.scrollTo(0, 0)}><p>1. Zip Pump</p></Link>
                        <Link to="/domestic-pump/ss-horizontal-openwell-pumps/zow-pump" onClick={() => window.scrollTo(0, 0)}><p>2. Zow Pump</p></Link>
                    </div>
                </div>
