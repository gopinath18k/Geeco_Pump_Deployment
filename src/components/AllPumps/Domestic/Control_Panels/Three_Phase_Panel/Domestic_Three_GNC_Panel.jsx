...
import "./Domestic_Three_GNC_Panel.css"
import Domestic_GNC_Pump from "../../../../../assets/Agriculture/Three-Phase-GNC-2.webp"
import { Link } from "react-router-dom";

export const DomesticGNCPanel = () => {
  return (
    <div className='Domestic_GNC_Panel_Main_Conatiner'>
        <div className="Domestic_GNC_Panel_Banner_container">
            <div className="Domestic_GNC_Panel_Banner_image">
                <img src={Domestic_GNC_Pump} alt="Domestic_GNC_Panel Banner" className="Domestic_GNC_Panel_images"/>
            </div>
            <div className="Domestic_GNC_Panel_Banner_Content">
                <h3>Control Panels</h3>
                <h2>GNC Panel 1</h2> 
                <p>Three Phase Panel</p>
            </div>
        </div>
        <div className="Domestic_GNC_Panel_Range_Container_one">
        ...
        <div className="Domestic_GNC_Panel_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_GNC_Panel_Descriptions">
            <div className="Domestic_GNC_Panel_text_conatiner">
                ...
                <div className="Domestic_GNC_Panel_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_GNC_Panel_Contact_Form'>
                                ...
                                <button className='Domestic_GNC_Panel_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        <Link to="/domestic-pump/control-panels/single-phase-panels/mcb-panel" onClick={() => window.scrollTo(0, 0)}><p>1. Single Phase Panel</p></Link>
                    </div>
                </div>
