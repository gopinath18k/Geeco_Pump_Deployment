...
import "./Domestic_Dewatering_Pump.css"
import Domestic_Dewatering_Pump from "../../../../assets/Domestic/Dewatering-Pump.webp"
import { Link } from "react-router-dom";

export const DomesticDewateringPump = () => {
  return (
    <div className='Domestic_Dewatering_Pump_Main_Conatiner'>
        <div className="Domestic_Dewatering_Pump_Banner_container">
            <div className="Domestic_Dewatering_Pump_Banner_image">
                <img src={Domestic_Dewatering_Pump} alt="Domestic_Dewatering_Pump Banner" className="Domestic_Dewatering_Pump_images"/>
            </div>
            <div className="Domestic_Dewatering_Pump_Banner_Content">
                <h3>Waste water Pumps</h3>
                <h2>Dewatering Pump</h2> 
                {/* <p>Slowspeed Monoblock</p> */}
            </div>
        </div>
        <div className="Domestic_Dewatering_Pump_Range_Container_one">
        ...
        <div className="Domestic_Dewatering_Pump_Range_Container_Two">
            <div className="Pump_Range_container col-3">
        ...
        <div className="Domestic_Dewatering_Pump_Descriptions">
            <div className="Domestic_Dewatering_Pump_text_conatiner">
                ...
                <div className="Domestic_Dewatering_Pump_Form_section">
                    <div className="Pump_Form_Section col-12 col-md-6 col-md-6 col-lg-6 col-xl-6">
                        <div className="Pump_Form_Contact">
                            ...
                            <form action="" className='Domestic_Dewatering_Pump_Contact_Form'>
                                ...
                                <button className='Domestic_Dewatering_Pump_Submit'>Send</button>
                            </form>
                        </div>
                    </div>
                    <div className="Related_Pump_Section col-12 col-md-6  col-md-6 col-lg-6 col-xl-6">
                        <h4>Related Pumps</h4>
                        {/* <Link to="/domestic-pump/jet-pumps/jet-pump-bm" onClick={() => window.scrollTo(0, 0)}><p>1. Jet Pumps BM</p></Link> */}
                    </div>
                </div>
